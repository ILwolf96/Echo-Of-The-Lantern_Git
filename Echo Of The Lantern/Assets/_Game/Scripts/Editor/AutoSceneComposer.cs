...
namespace EchoOfTheLantern.EditorTools
{
    ...
    public static class AutoSceneComposer
    {
        ...
        private static void BuildMenuUI(Transform canvasRoot)
        {
            ...
            MenuPlayButton playTarget = playButton.AddComponent<MenuPlayButton>();

            Button button = playButton.GetComponent<Button>();
            UnityEventTools.AddPersistentListener(button.onClick, playTarget.PlayGame);
        }
        ...
        private static GameObject CreateEndPanel(Transform parent, string name, string message)
        {
            ...
            EndScreenController endScreen = buttonObj.AddComponent<EndScreenController>();
            Button button = buttonObj.GetComponent<Button>();
            UnityEventTools.AddPersistentListener(button.onClick, endScreen.RestartGame);
